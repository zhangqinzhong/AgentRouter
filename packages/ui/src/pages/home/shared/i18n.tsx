...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  en: {
    ...
    text: {
      ...
      "AgentRouter Route Map": "AgentRouter Route Map",
      ...
      "tokens routed through AgentRouter": "tokens routed through AgentRouter",
      "Top model": "Top model",
      "Top provider": "Top provider",
      "No provider activity": "No provider activity",
      "Peak day": "Peak day",
      "Generated by AgentRouter": "Generated by AgentRouter",
      "Range": "Range",
  ...
  zh: {
    ...
    text: {
      ...
      "AgentRouter Route Map": "AgentRouter 路由图",
      "Model Leaderboard": "模型排行榜",
      "AI Fuel Cockpit": "AI 燃料仪表",
      "Token Calendar Poster": "Token 日历海报",
      "Spend Receipt": "消费小票",
      "tokens routed through AgentRouter": "通过 AgentRouter 路由的 Token",
      "Top model": "最高频模型",
      "Top provider": "最高频供应商",
      "No provider activity": "暂无供应商活动",
      "Peak day": "峰值日期",
      "Generated by AgentRouter": "由 AgentRouter 生成",
      "Range": "范围",
      "W": "三",
      "Yes": "是",
