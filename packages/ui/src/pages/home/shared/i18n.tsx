...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  en: {
    ...
    settings: {
      ...
      toolHubBrowserAutomationDescription: "Expose AgentRouter Desktop's built-in browser automation tools through ToolHub.",
    ...
    text: {
      ...
      "Choose the initial time range for each page. Changes apply the next time you open that page.": "Choose the initial time range for each page. Changes apply the next time you open that page.",
      ...
      "This year": "This year",
      "Filter logs, models, requests, or responses": "Filter logs, models, requests, or responses",
      ...
      "Complete speed sample": "Complete speed sample",
      "Partial speed sample": "Partial speed sample",
      "Usage missing speed sample": "Usage missing speed sample",
      "Insufficient tokens speed sample": "Insufficient tokens speed sample",
      "Unsupported protocol speed sample": "Unsupported protocol speed sample",
      "Hidden reasoning speed sample": "Hidden reasoning speed sample",
      "Batched output speed sample": "Batched output speed sample",
      "Validated samples: (output tokens − 1) ÷ active output window in seconds.": "Validated samples: (output tokens − 1) ÷ active output window in seconds.",
      "Legacy logs use the TPOT estimate: (output tokens − 1) ÷ (total duration − time to first token), with time in seconds.": "Legacy logs use the TPOT estimate: (output tokens − 1) ÷ (total duration − time to first token), with time in seconds.",
      "Incomplete or unreliable samples show no rate. Expand the request to see the sample status.": "Incomplete or unreliable samples show no rate. Expand the request to see the sample status.",
      ...
      "Copy": "Copy",
      "Formula: output tokens ÷ total request duration in seconds.": "Formula: output tokens ÷ total request duration in seconds.",
      "Includes the wait for the first token and applies to streaming and non-streaming requests. Output usage comes from the provider and may include reasoning tokens.": "Includes the wait for the first token and applies to streaming and non-streaming requests. Output usage comes from the provider and may include reasoning tokens.",
      "Example: 100 output tokens over a 5-second request gives an average throughput of 20 token/s.": "Example: 100 output tokens over a 5-second request gives an average throughput of 20 token/s.",
      "Output rate (TPOT estimate)": "Output rate (TPOT estimate)",
      "Formula: (output tokens − 1) ÷ (total duration − time to first token), with time in seconds.": "Formula: (output tokens − 1) ÷ (total duration − time to first token), with time in seconds.",
      "Available for streaming requests with more than one output token and a valid time interval. Output usage comes from the provider and may include reasoning tokens.": "Available for streaming requests with more than one output token and a valid time interval. Output usage comes from the provider and may include reasoning tokens.",
      "This gateway-observed estimate is affected by buffering, batched delivery, and short responses. It does not measure internal model generation speed. Average throughput includes the full request duration.": "This gateway-observed estimate is affected by buffering, batched delivery, and short responses. It does not measure internal model generation speed. Average throughput includes the full request duration.",
      ...
      "Scanned requests": "Scanned requests",
      ...
      "状态": "Status",
      "模型": "Model",
      "AgentRouter compact for Claude Code": "AgentRouter compact for Claude Code",
      "Use AgentRouter context archive when Claude Code runs /compact.": "Use AgentRouter context archive when Claude Code runs /compact.",
      ...
      "平均吞吐率说明": "Average throughput details",
      "公式：输出 Token 数 ÷ 请求总耗时（秒）。": "Formula: output tokens ÷ total request duration in seconds.",
      "包含等待首 Token 的时间，适用于流式和非流式请求。输出 Token 按供应商返回的用量统计，可能包含思考 Token。": "Includes the wait for the first token and applies to streaming and non-streaming requests. Output usage comes from the provider and may include reasoning tokens.",
      "例如：输出 100 Token，总耗时 5 秒，平均吞吐率为 20 token/s。": "Example: 100 output tokens over a 5-second request gives an average throughput of 20 token/s.",
      "反馈": "Feedback",
      ...
      "Auto detect protocols description": "When enabled, AgentRouter probes the endpoint while editing and uses the detected protocols and models to update this provider. Turn it off to keep manually selected protocols and custom model IDs unchanged.",
      "Auto detect protocols info": "Auto detect protocols info",
      "Available models": "Available models",
      "Available after saving": "Available after saving",
      "Automatic": "Automatic",
      "Add credentials": "Add credentials",
      "Add the API key AgentRouter will use for model requests.": "Add the API key AgentRouter will use for model requests.",
      ...
      "Choose a provider endpoint so AgentRouter can detect compatible protocols.": "Choose a provider endpoint so AgentRouter can detect compatible protocols.",
      ...
      "Grok CLI profiles use AgentRouter scope and CLI entry mode.": "Grok CLI profiles use AgentRouter scope and CLI entry mode.",
      ...
      "AgentRouter scanned this computer for local Claude Code, Codex, Grok CLI, Kimi CLI, OpenCode CLI, and ZCode providers. Click Import to add one as a gateway provider.": "AgentRouter scanned this computer for local Claude Code, Codex, Grok CLI, Kimi CLI, OpenCode CLI, and ZCode providers. Click Import to add one as a gateway provider.",
      "Locked": "Locked",
      "Manual": "Manual",
      ...
      "Enhanced route description Claude Code": "AgentRouter built-in Claude Code routing optimizes requests to third-party models for this profile.",
      "Enhanced route description Codex": "AgentRouter built-in Codex routing optimizes requests to third-party models for this profile.",
      ...
      "Send a request through AgentRouter, then refresh this page to inspect it.": "Send a request through AgentRouter, then refresh this page to inspect it.",
      "providers": "providers",
      ...
      "No model usage yet": "No model usage yet",
      ...
      "AgentRouter routes media through the selected ai-gateway provider. Imported Grok Agents reuse their existing login automatically.": "AgentRouter routes media through the selected ai-gateway provider. Imported Grok Agents reuse their existing login automatically.",
  ...
  zh: {
    ...
    settings: {
      ...
      toolHubBrowserAutomationDescription: "通过 ToolHub 暴露 AgentRouter Desktop 的内置浏览器自动化工具。",
    ...
    text: {
      "Default time ranges": "默认时间范围",
      "Default time range": "默认时间范围",
      "Choose the initial time range for each page. Changes apply the next time you open that page.": "分别设置各页打开时的时间范围，下次进入页面时生效。",
      ...
      "This month": "本月",
      "This year": "今年",
      "Filter logs, models, requests, or responses": "筛选日志、模型、请求或响应",
      "Next page": "下一页",
      "Loading logs": "正在加载日志",
      "Time": "时间",
      "First token": "首 Token",
      ...
      "Usage missing speed sample": "缺少用量数据",
      ...
      "Validated samples: (output tokens − 1) ÷ active output window in seconds.": "有效样本：输出 Token 数减 1，再除以连续输出窗口（秒）。",
      "Legacy logs use the TPOT estimate: (output tokens − 1) ÷ (total duration − time to first token), with time in seconds.": "旧日志使用 TPOT 估算：(输出 Token 数 − 1) ÷ (总耗时 − 首 Token 延迟)，时间单位为秒。",
      "Incomplete or unreliable samples show no rate. Expand the request to see the sample status.": "不完整或不可靠的样本不显示速率，展开请求可查看样本状态。",
      "Average throughput": "平均吞吐率",
      "Filter JSON...": "筛选 JSON...",
      "Formula: output tokens ÷ total request duration in seconds.": "公式：输出 Token 数 ÷ 请求总耗时（秒）。",
      "Includes the wait for the first token and applies to streaming and non-streaming requests. Output usage comes from the provider and may include reasoning tokens.": "包含等待首 Token 的时间，适用于流式和非流式请求。输出 Token 按供应商返回的用量统计，可能包含思考 Token。",
      "Example: 100 output tokens over a 5-second request gives an average throughput of 20 token/s.": "例如：输出 100 Token，总耗时 5 秒，平均吞吐率为 20 token/s。",
      "Output rate (TPOT estimate)": "输出速率（TPOT 估算）",
      "Formula: (output tokens − 1) ÷ (total duration − time to first token), with time in seconds.": "公式：(输出 Token 数 − 1) ÷ (总耗时 − 首 Token 延迟)，时间单位为秒。",
      "Available for streaming requests with more than one output token and a valid time interval. Output usage comes from the provider and may include reasoning tokens.": "仅适用于流式请求，且输出 Token 数大于 1、时间间隔有效。Token 数按供应商返回的输出用量计，可能包含思考 Token。",
      "This gateway-observed estimate is affected by buffering, batched delivery, and short responses. It does not measure internal model generation speed. Average throughput includes the full request duration.": "这是网关观测到的估算值，受网络缓冲、批量返回和短回复影响，不代表模型内部的真实生成速度。平均吞吐率则包含请求的全部耗时。",
      "Log retention days": "日志保存天数",
      "Captured requests": "捕获请求",
      "Request logs": "请求日志",
      "API keys": "API 密钥",
      "Global routing": "全局路由",
      ...
      "Configured profiles": "配置档案",
      "Scanned requests": "已扫描请求",
      "Session tokens": "会话 Token",
      "Session cost": "会话成本",
      "Back to profile": "返回配置档案",
      ...
      "AgentRouter compact for Claude Code": "Claude Code 使用 AgentRouter 压缩",
      "Use AgentRouter context archive when Claude Code runs /compact.": "Claude Code 执行 /compact 时改用 AgentRouter 上下文归档。",
      ...
      "Add the API key AgentRouter will use for model requests.": "填写 AgentRouter 发起模型请求时使用的 API Key。",
      "Add limit": "添加限制",
      "Add parameter": "添加参数",
      "Add Profile": "添加配置",
      "Add profile": "添加配置",
      ...
      "Auto detect protocols description": "开启后，AgentRouter 会在编辑时探测接口，并用探测到的协议和模型更新此供应商。关闭后，手动选择的协议和自定义模型 ID 会保持不变。",
      ...
      "Check trust": "检查信任",
      "Choose where each agent uses AgentRouter.": "选择每个 Agent 在哪里使用 AgentRouter。",
      "Choose provider": "选择供应商",
      "Choose a provider endpoint so AgentRouter can detect compatible protocols.": "选择供应商端点后，AgentRouter 才能探测兼容协议。",
      ...
      "Grok CLI": "Grok CLI",
      "Grok CLI profiles use AgentRouter scope and CLI entry mode.": "Grok CLI 配置档案固定使用 AgentRouter 作用范围和 CLI 入口模式。",
      "Grok model": "Grok 模型",
      "Kimi CLI": "Kimi CLI",
      "Kilo CLI": "Kilo CLI",
      "Kilo model": "Kilo 模型",
      ...
      "Selecting a local script file requires AgentRouter Desktop. Enter the server-local path manually when using the web UI.": "选择本地脚本文件需要使用 AgentRouter 桌面版；使用 Web UI 时请手动输入服务器本地路径。",
      ...
      "Custom": "自定义",
      "Select all": "全选",
      "Model pricing and capabilities": "模型定价与能力",
      "Start date": "开始日期",
      "End date": "结束日期",
      "Apply": "应用",
      "Show earlier": "查看更早",
      ...
      "Description": "描述",
      "AgentRouter scanned this computer for Claude Code, Codex, Grok CLI, OpenCode CLI, and ZCode login states. Click Import to add one as a gateway provider.": "AgentRouter 已扫描本机的 Claude Code、Codex、Grok CLI、OpenCode CLI 和 ZCode 登录态。点击导入即可添加为网关供应商。",
      ...
      "AgentRouter scanned this computer for local Claude Code, Codex, Grok CLI, Kimi CLI, OpenCode CLI, and ZCode providers. Click Import to add one as a gateway provider.": "AgentRouter 已扫描本机的 Claude Code、Codex、Grok CLI、Kimi CLI、OpenCode CLI 和 ZCode 供应商。点击导入即可添加为网关供应商。",
      "Locked": "已加密",
      ...
      "Bot only forwards messages when opening the APP from AgentRouter. CLI does not forward messages yet.": "Bot仅在使用AgentRouter打开APP的情况下才会转发消息，cli目前不会转发消息",
      ...
      "Browser request uses AgentRouter Desktop's built-in browser login state. Sign in in the in-app browser before testing.": "浏览器请求会使用 AgentRouter Desktop 内置浏览器的登录态。测试前请先在内置浏览器中登录。",
      ...
      "Open CA": "打开 CA",
      "Open Profile": "打开配置",
      "Only opened from AgentRouter": "仅从 AgentRouter 打开",
      ...
      "Plugin app URL must be an http(s) URL or a AgentRouter gateway path.": "插件 App URL 必须是 http(s) URL 或 AgentRouter 网关路径。",
      ...
      "YOLO (skip permission prompts)": "YOLO（跳过权限确认）",
      "Additional launch arguments": "附加启动参数",
      "One argument per line. No shell quoting is needed.": "每行填写一个参数，无需添加 shell 引号。",
      "Use 1–48 letters, digits, hyphens or underscores, starting with a letter. Reserved commands are not allowed.": "以字母开头，限 1–48 位字母、数字、连字符或下划线，不能使用保留命令。",
      "Optional. Start this profile by typing the alias in a terminal.": "选填。在终端输入别名即可启动此档案。",
      ...
      "Settings": "设置项",
      "Enhanced route": "增强路由",
      "Enhanced route description Claude Code": "AgentRouter 内置的 Claude Code 路由会针对该配置使用三方模型时的请求做优化。",
      "Enhanced route description Codex": "AgentRouter 内置的 Codex 路由会针对该配置使用三方模型时的请求做优化。",
      ...
      "Select bot": "选择 Bot",
      "Select data": "选择数据",
      "Send a request through AgentRouter, then refresh this page to inspect it.": "通过 AgentRouter 发送一次请求，然后刷新此页面查看日志。",
      "Server": "服务",
      ...
      "AgentRouter routes media through the selected ai-gateway provider. Imported Grok Agents reuse their existing login automatically.": "AgentRouter 通过 ai-gateway 路由到所选媒体供应商；导入的 Grok Agent 会自动复用现有登录态。",
      ...
      "Credit balance": "信用余额",
      "AgentRouter will fetch this HTTPS manifest with strict safety checks before showing provider details.": "AgentRouter 会在严格安全检查后拉取这个 HTTPS manifest，再展示供应商详情。",
      ...
      "Standard usage endpoint will try provider-hosted AgentRouter account endpoints.": "标准用量端点会尝试供应商托管的 AgentRouter 账户端点。",
      "Sub limit": "订阅上限",
      "Sub rem": "订阅剩余",
      "Start check": "开始检测",
      ...
      "macOS did not allow AgentRouter to request administrator authorization:": "macOS 未允许 AgentRouter 请求管理员授权：",
      ...
      "If trust is still not detected, open Keychain Access > System and find the AgentRouter MITM Proxy certificate.": "如果仍未检测到信任，请打开“钥匙串访问”>“系统”，找到 AgentRouter MITM Proxy 证书。",
      ...
      "Start service": "启动服务",
      "Stop": "停止",
      "Start using AgentRouter.": "开始使用 AgentRouter。",
      ...
      "Welcome to AgentRouter": "欢迎使用AgentRouter",
      "Trusted": "已信任",
