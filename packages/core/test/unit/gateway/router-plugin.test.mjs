...
test("AgentRouter router core plugin applies OpenRouter discount provider routing", async (t) => {
  ...
  assert.equal(transformed.responseHeaders["x-ar-openrouter-discount-reason"], "switched-cheaper-after-cache-loss");
  assert.equal(transformed.responseHeaders["x-ar-openrouter-discount-selected-provider"], "cheap");
  assert.equal(transformed.responseHeaders["x-ar-openrouter-discount-model"], "author/router-plugin-discount-model");
