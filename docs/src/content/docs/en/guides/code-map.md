...
| Overview | [overview.tsx](https://github.com/zhangqinzhong/AgentRouter/blob/main/packages/ui/src/pages/home/components/overview.tsx) | Flat overview page: stat strip, system status, trend, and model/client/provider breakdowns |
